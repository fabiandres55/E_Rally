...
func _process(delta):
	...
	if Dominio>= time:
		...
		var y = (110)/(1+0.000000000000006*exp(0.061*time))
		$Motor/Motor_container/Motor_graficos._trayectoria_funcion_particula(time,y)
		
		var y_2 = (160)/(1+0.0183*exp(0.0237*time))
		$Motor/Motor_container/Motor_graficos2._trayectoria_funcion_particula(time,y_2)
		
		var y_3 = (150)/(1+0.0006*exp(0.0126*time))
		$Motor/Motor_container/Motor_graficos3._trayectoria_funcion_particula(time,y_3)
		
		var y_5 = (180)/(1+0.0321*exp(0.0117*time))  ### true
		$Motor/Motor_container/Motor_graficos5._trayectoria_funcion_particula(time,y_5)
...
func _evaluacion_punto(dominio):
	if dominio<= 600 and dominio> -600 : 
		...
		var y = (110)/(1+0.000000000000006*exp(0.061*dominio))
		$Motor/Motor_container/Motor_graficos._punto_position(dominio,y)
		
		var y_2 = (160)/(1+0.0183*exp(0.0237*dominio))
		$Motor/Motor_container/Motor_graficos2._punto_position(dominio,y_2)
		
		var y_3 = (150)/(1+0.0006*exp(0.0126*dominio))### true
		...
		var y_5 = (180)/(1+0.0321*exp(0.0117*dominio))   
		$Motor/Motor_container/Motor_graficos5._punto_position(dominio,y_5)
		
	pass

func _ready():
	$Plano.p_llegada_x =  350
	$Plano.p_llegada_y = 120
	$Plano.p_Inicio_y = 160
	$Plano.p_Inicio_x = 150
	...
	#
	$Motor/Motor_container/Motor_graficos4.find_node("Bola").modulate = "00ffe7"
	$Motor/Motor_container/Motor_graficos4.find_node("trayecto").modulate = "00ffe7"
	
	$Motor/Motor_container/Motor_graficos5.find_node("Bola").modulate = "00ffe7"
	$Motor/Motor_container/Motor_graficos5.find_node("trayecto").modulate = "00ffe7"
...
func _on_cortina_animation_finished(anim_name):
	...
	if Next_Rally_1 == true:
		Next_Rally_1 = false
		get_tree().change_scene("res://scenes/Motor_selection_5/Rally_1/Rally_1.tscn")
	pass # Replace with function body.
...
func _selec_motor(num):
	...
	$Motor/Motor_container/Motor_graficos5/Button_5.pressed = false
	...
	if num == 0:
		...
		$Motor/Motor_container/Motor_graficos5/Button_5.pressed = true
...
func _motor_vista(num):
	...
	$Motor/Motor_container/Motor_graficos5.visible = false
	if num == 0:
		...
		if valor_entrada*100 == valor_correcto*100:
			$Motor/Motor_container/Motor_graficos5.visible = true
		else:
